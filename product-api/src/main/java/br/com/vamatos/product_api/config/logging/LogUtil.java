...
package com.seu.pacote.logging;
...
public class LogUtil {
    ...
    private static final String SERVICE_ID = "auth-api"; // ou seu serviceId padrão
    ...
    private static Map<String, Object> baseLog(
        ...
        log.put("transactionId", transactionId != null ? transactionId : UUID.randomUUID().toString());
        log.put("serviceId", SERVICE_ID);
        log.put("route", route);
    ...
    public static void logInfo(String message, String transactionId, Map<String, Object> data) {
    ...
    public static void logSuccess(String message, String transactionId, String route, String method,
                                  int status, long duration, String ip, String userId, Map<String, Object> data) {
        RequestResponseLogger.log(
